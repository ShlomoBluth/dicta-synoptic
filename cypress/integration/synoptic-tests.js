...
describe('synoptic-tests',()=>{
    ...
    it('Synopsis builder download',()=>{
        ...
        //     })
        // }).then(()=>{
            const filename = path.join('cypress/downloads/8d21a218-8e4f-442b-8aa0-884b5992e407-vert.xlsx')
            const downloadedFilename = path.join(downloadsFolder,'8d21a218-8e4f-442b-8aa0-884b5992e407-vert.xlsx')
            cy.readFile('/__w/dicta-synoptic/dicta-synoptic/cypress/downloads/8d21a218-8e4f-442b-8aa0-884b5992e407-vert.xlsx','binary',{timeout:15000}).should('not.be.null')
